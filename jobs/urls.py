...
urlpatterns = [
    ...
    path("selected_applicants/", views.view_selected_applicants, name="view_selected_applicants"),
    path("all_applicants/reject_applicant/<slug:applicant>/",views.reject_applicant, name="reject_applicant"),
    path("all_applicants/accept_applicant/<slug:applicant>/",views.accept_applicant, name="accept_applicant"),
